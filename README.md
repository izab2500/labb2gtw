...
### Webbplatsstruktur
- Skapa tre sidor: Startsida, Bildredigering och Om mig.
- Webbplatsen ska ha ett fungerande navigationssystem och vara responsiv.
- Inkludera en logotyp (SVG) och favicon (ICO och PNG) på alla sidor.
- På startsidan ska en bildserie visas och en kort beskrivning av uppgiften finnas.
- På bildredigeringssidan ska tre redigerade bilder visas bredvid deras originalbilder med förklaringar på de gjorda ändringarna.
- Skapa en frilagd porträttbild till "Om mig"-sidan.
...
- Faviconen ska skapas i både ICO och PNG-format, och den ska visas i webbläsarfliken.
...
- Använd HTML och CSS och möjligtvis javaScript.
